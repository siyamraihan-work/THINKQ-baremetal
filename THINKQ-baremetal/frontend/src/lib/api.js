...
export function getAdminLookups() {
  return request('/api/admin/lookups', { method: 'GET' })
}
...
export function updateCourseStatus(courseId, active) {
  return request(`/api/admin/courses/${courseId}/status`, {
    method: 'PATCH',
...
export function createBuilding(payload) {
  return request('/api/admin/buildings', {
    method: 'POST',
    body: JSON.stringify(payload)
  })
}
...
export function updateLocationStatus(locationId, active) {
  return request(`/api/admin/locations/${locationId}/status`, {
    method: 'PATCH',
    body: JSON.stringify({ active })
  })
}
