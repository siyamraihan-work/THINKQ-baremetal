...
app.get('/api/admin/users', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
...
app.patch('/api/admin/users/:id/role', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
    const body = z.object({
...
app.post('/api/admin/courses', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
    const body = z.object({
...
app.patch('/api/admin/courses/:id/status', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
...
app.delete('/api/admin/courses/:id', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
...
app.post('/api/admin/buildings', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
    const body = z.object({
...
app.post('/api/admin/rooms', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
    const body = z.object({
...
app.post('/api/admin/locations', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
    const body = z.object({
...
app.patch('/api/admin/locations/:id/status', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
    const body = z.object({ active: z.boolean() }).parse(req.body);
...
app.delete('/api/admin/locations/:id', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
...
app.get('/api/admin/lookups', requireSession(redis), requireRole('ADMIN'), async function(req, res, next) {
  try {
