  ...
  return (
    <section className="glass-card hero-panel">
      ...
      <p>
        ...
        and microservice gateway paths. This screen is intentionally minimal so you can restyle it later.
      </p>
      <div className="feature-row">
        ...
        <article className="feature-box">
          ...
          <p className="mini-copy">Frontend Nginx proxies directly to your backend gateway on the same machine.</p>
        </article>
      </div>
    </section>
  )
